...
export default function Dashboard() {
  ...
  return <main className="dashboard-page">
    ...
    <section className="dashboard-grid">
      ...
      <section className="panel progress-panel"><div className="section-heading"><div><h2>Trivia & Challenges</h2><p>Test your market wisdom & win XP</p></div><Link to="/lessons">Solve challenges →</Link></div><div className="progress-orbit"><div><b>{profile.level}</b><small>LEVEL</small></div></div><p className="progress-copy"><b>{profile.xp} XP earned</b><br />Solve trivia and make thoughtful trades to unlock new levels.</p></section>
    </section>
  </main>;
}
